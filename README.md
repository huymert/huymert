...
Hi there! 👋 I am Hà Gia Huy, a final-year Electronics and Telecommunications student at the University of Science, VNU-HCM, specializing in Embedded Systems and IoT.
...
#### 📱 [Staff Management Application](https://github.com/huymert/Staff-Management-Application)
- **What it is**: Android app for comprehensive HR management featuring role-based access control (RBAC), real-time group chat, and a Gemini-powered RAG AI assistant.
- **Deliverables**: 🛠️ [Source Code](https://github.com/huymert/Staff-Management-Application) | 📥 [Pre-built Release APK](https://github.com/huymert/Staff-Management-Application/releases) | 🔍 [Manual Test Cases Showcase](https://github.com/huymert/Staff-Management-Application#%EF%B8%8F-quality-assurance--testing-qc-showcase)
- **Key achievement / QC Focus**: Developed secure role-based navigation; authored and executed **15+ manual test cases** covering authentication stability, input constraints, and strict access control boundaries (Admin vs. Manager vs. Employee).
